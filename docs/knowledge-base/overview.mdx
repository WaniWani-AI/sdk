...
If you're running your own MCP server, create a simple script to read your docs and push them to WaniWani. This runs standalone — it doesn't need to be inside an MCP server.

...
<CardGroup cols={2}>
  <Card title="Sales funnels" icon="filter" href="/funnels/sales-funnel">
    Qualify intent, capture lead data, route to the right next step.
  </Card>
  <Card title="Lead generation" icon="user-plus" href="/funnels/lead-generation">
    Collect email, role, and use case. Push to your CRM.
  </Card>
  <Card title="Booking flows" icon="calendar" href="/funnels/booking">
    Pick a service, pick a slot, confirm. Branch on availability.
  </Card>
  <Card title="Insurance and pricing quotes" icon="shield" href="/funnels/insurance-quote">
...
The flow engine is open source. Set `WANIWANI_API_KEY` to add hosted features (state, tracking, funnel analytics, knowledge base, chat widget). See [Tiers](/reference/tiers).

## Next

Head to the [Quickstart](/quickstart) to get a flow running in under 5 minutes, or jump straight into [building a funnel](/funnels/overview).

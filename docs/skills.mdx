...
A separate skill is available to generate the submission documents required for the ChatGPT App Store. It analyzes your MCP server's tools, flows, and widgets to produce two Notion pages:

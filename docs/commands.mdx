...
The WaniWani SDK skill ships with guided commands (playbooks) that walk your AI agent through common tasks step by step. After [installing the skill](/skills), invoke them as slash commands in Claude Code, Cursor, or any compatible agent.

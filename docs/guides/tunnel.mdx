...
<Note>
  **Managed projects** handle this automatically. `bun dev` starts a Cloudflare tunnel and prints the public URL. This guide is for **external projects** or custom setups.
</Note>

...
This is intentional. No silent fallback to a backend that does not exist in production. See [self-hosting the engine](/flows/self-hosting) for the fully offline path.

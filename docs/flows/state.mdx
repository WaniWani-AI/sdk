...
This page covers the state schema: the typed fields a flow collects. For where state lives across calls, see [Persistence](/flows/kv-store) and [Tiers](/reference/tiers).

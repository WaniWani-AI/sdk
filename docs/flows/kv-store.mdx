...
keywords: ["KV store", "Redis adapter", "Upstash adapter", "Cloudflare KV adapter", "DynamoDB adapter", "MemoryKvStore"]
---
...
See the [Platform overview](/platform/overview) for when the hosted store makes sense versus a self-hosted adapter.

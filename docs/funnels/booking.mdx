...
- **Add a confirmation widget.** Use `showWidget` to display the booking card visually. See the [Pet Insurance Quote example](/flows/examples) for the widget handoff pattern.

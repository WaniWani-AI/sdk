---
title: Build an insurance quote MCP
...
The most complete example in the docs is the **[Pet Insurance Quote flow](/flows/examples)**. It demonstrates every pattern an insurance quote funnel needs:
...
Open [the Pet Insurance Quote example](/flows/examples) for the full ~250-line code.
...
See the [full Pet Insurance Quote code](/flows/examples) for working versions of `show_confirmation`, `show_pricing`, the correction loop, and the adjustment loop.
...
<CardGroup cols={2}>
  <Card title="Pet Insurance Quote (full example)" icon="shield" href="/flows/examples" />
  <Card title="Widgets in flows" icon="window-maximize" href="/flows/examples" />
